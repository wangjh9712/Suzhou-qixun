	...
	<div style="background-color: #eee; padding: 60px 20px; text-align: center; margin: 30px 0;color: #666;">
		<div class="container">
			<div class="row">
				...
				<div class="tabtxt col-xs-12 col-sm-6 col-sm-pull-6 col-md-6 col-md-pull-6 col-lg-6 col-lg-pull-6 text-center" style="margin-top: 0px; height:20px; ">
	                <h3>强大的学习体系</h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
					<img src="img/tab3.png" class="tabimg img-responsive center-block" style="width: 65%; height: 65%;vertical-align: middle;">
				</div>
